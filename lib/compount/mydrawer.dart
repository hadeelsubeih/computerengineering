import 'package:computerengineering/Screens/ActivitiesHome.dart';
        ...
        children: <Widget>[
          UserAccountsDrawerHeader(
            ...
            currentAccountPicture: CircleAvatar(
              backgroundColor: Color(0xff018476),
                child: Icon(Icons.person, color:Color(0xffffffff),size: 35,)),
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(context, new MaterialPageRoute(builder: (context)=>  ActivitiesHome()));
            },
          ),
                    isSignIn ?  ListTile(
          ...
          //   ],
          // ),
          Divider(color: Color(0xff018476)),
          ListTile(
